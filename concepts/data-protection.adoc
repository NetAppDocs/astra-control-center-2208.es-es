...
image:acc-backup_4in.png["Imagen de copia de seguridad y restauración programada"]
...
image:acc-replication_4in.png["Replicación y recuperación tras fallos de imagen"]
